...
## IMPORTANT NOTE: This is a clone of the [Skeletons](https://github.com/badjio/skeletons) package in order to fix the theme errors on `backgroundColor` and `headline6`.

Original Repo: [https://github.com/badjio/skeletons](https://github.com/badjio/skeletons)
